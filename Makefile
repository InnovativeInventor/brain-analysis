...
exe: main
	./main data/coords.txt data/img_edge_list.txt data/results/img_ranks.txt data/results/img_girvan_newman.txt 0.14
	./main data/coords.txt data/pcp_edge_list.txt data/results/pcp_ranks.txt data/results/pcp_girvan_newman.txt 0.14
exe_test: test
	./test
